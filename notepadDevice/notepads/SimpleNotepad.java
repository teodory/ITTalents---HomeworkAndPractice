...
import notepadDevice.Page;
import notepadDevice.interfaces.INotepad;
...
public class SimpleNotepad implements INotepad {
	...
	public SimpleNotepad(int numberOfPages) {
		...
		printCreationMessage(numberOfPages);
	}

	private void printCreationMessage(int numberOfPages) {
